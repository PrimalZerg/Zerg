...
public class Modelroach<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftleg3 = partdefinition.addOrReplaceChild("leftleg3",
				CubeListBuilder.create().texOffs(70, 61).addBox(0.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 16.0F, 9.0F, 0.0F, -0.6545F, 0.0F));

		PartDefinition cube_r17 = leftleg3.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(71, 72).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(9.0115F, 6.3116F, 0.0F, 0.0F, 0.0F, -0.0873F));

		PartDefinition cube_r18 = leftleg3
				.addOrReplaceChild("cube_r18",
						CubeListBuilder.create().texOffs(45, 64).addBox(0.0F, -5.5F, -1.5F, 2.0F, 12.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(6.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition leftleg1 = partdefinition.addOrReplaceChild("leftleg1",
				CubeListBuilder.create().texOffs(64, 35).addBox(0.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 16.0F, -3.25F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r19 = leftleg1.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(55, 64).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(9.0115F, 6.3116F, 0.0F, 0.0F, 0.0F, -0.0873F));

		PartDefinition cube_r20 = leftleg1
				.addOrReplaceChild("cube_r20",
						CubeListBuilder.create().texOffs(35, 64).addBox(0.0F, -5.5F, -1.5F, 2.0F, 12.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(6.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition rightleg3 = partdefinition.addOrReplaceChild("rightleg3",
				CubeListBuilder.create().texOffs(49, 0).addBox(-7.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, 16.0F, 9.0F, 0.0F, 0.6545F, 0.0F));

		PartDefinition cube_r21 = rightleg3.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(26, 63).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-9.0115F, 6.3116F, 0.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition cube_r22 = rightleg3
				.addOrReplaceChild("cube_r22",
						CubeListBuilder.create().texOffs(39, 0).addBox(-2.0F, -5.5F, -1.5F, 2.0F, 12.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(-6.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1745F));
		...
		PartDefinition cube_r24 = rightleg2
		...
		PartDefinition rightleg1 = partdefinition.addOrReplaceChild("rightleg1",
				CubeListBuilder.create().texOffs(31, 25).addBox(-7.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, 16.0F, -3.25F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r25 = rightleg1.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(0, 63).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-9.0115F, 6.3116F, 0.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition cube_r26 = rightleg1
				.addOrReplaceChild("cube_r26",
						CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -5.5F, -1.5F, 2.0F, 12.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(-6.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1745F));

		PartDefinition leftarm = partdefinition.addOrReplaceChild("leftarm",
				CubeListBuilder.create().texOffs(55, 25)
						.addBox(-1.0F, -11.0F, -1.0F, 1.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(34, 48)
		...
		PartDefinition cube_r27 = leftarm.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(37, 6).addBox(-0.5F, 0.0F, -10.5F, 1.0F, 2.0F, 17.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, -14.0F, -2.0F, 0.1745F, 0.0F, 0.0F));

		PartDefinition rightarm = partdefinition.addOrReplaceChild("rightarm",
				CubeListBuilder.create().texOffs(49, 25)
						.addBox(0.0F, -11.0F, -1.0F, 1.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(48, 25)
		...
		PartDefinition cube_r28 = rightarm.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(29, 29).addBox(-0.5F, 0.0F, -10.5F, 1.0F, 2.0F, 17.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, -14.0F, -2.0F, 0.1745F, 0.0F, 0.0F));
