...
public class Modelarmor<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r9 = Head.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(24, 0).addBox(-1.75F, -3.75F, -5.75F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(10.0F, 0.0F, 0.0F, 0.0F, 0.9599F, 0.0F));
		PartDefinition cube_r10 = Head.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(24, 0).addBox(-6.0F, -3.75F, -5.75F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-10.0F, 0.0F, 0.0F, 0.0F, -0.9599F, 0.0F));
