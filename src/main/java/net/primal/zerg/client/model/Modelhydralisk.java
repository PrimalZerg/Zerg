...
public class Modelhydralisk<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("zerg", "modelhydralisk"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(47, 0).addBox(-5.0F, 5.0F, -10.75F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 80)
		...
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(10, 55).addBox(-1.25F, -5.0F, -2.25F, 1.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 80)
		...
		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(60, 33).addBox(-1.0F, -6.25F, -3.5F, 1.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(23, 96)
		...
		PartDefinition cube_r3 = head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -2.0F, -4.25F, 5.0F, 6.0F, 23.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, 0.1309F, 0.0F, 0.0F));
		PartDefinition cube_r4 = head.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(72, 98).addBox(-5.0F, -3.0F, -11.0F, 5.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, 0.2618F, 0.0F, 0.0F));
		PartDefinition cube_r5 = head.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(50, 33).addBox(-6.0F, -3.0F, -2.0F, 7.0F, 2.0F, 17.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, 0.3491F, 0.0F, 0.0F));
		PartDefinition cube_r6 = head.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(24, 35).addBox(4.0F, -1.0F, -4.0F, 3.0F, 4.0F, 20.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.0F, 3.0F, 0.0F, 0.3193F, 0.2909F, 0.0945F));
		PartDefinition cube_r7 = head.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(36, 9).addBox(-7.0F, -1.0F, -4.0F, 3.0F, 4.0F, 20.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, 0.3193F, -0.2909F, -0.0945F));
		PartDefinition jaw = head.addOrReplaceChild("jaw",
				CubeListBuilder.create().texOffs(62, 19).addBox(-2.0F, 5.5778F, -8.3941F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(93, 0)
		...
		PartDefinition tail = partdefinition.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(101, 69).addBox(-9.0F, 1.0F, -2.0F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(94, 100)
		...
		PartDefinition cube_r8 = tail.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 96).addBox(-2.5F, -5.0F, -0.75F, 5.0F, 2.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(62, 0)
		...
		PartDefinition cube_r9 = tail.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(78, 19).addBox(7.5F, -1.5F, 8.5F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 69)
		...
		PartDefinition cube_r10 = tail.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(24, 80).addBox(-5.5F, -1.5F, 10.5F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(93, 7)
						.addBox(-3.5F, -1.5F, -1.5F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.5F, 4.5F, 10.5F, 0.0F, 0.4363F, 0.0F));
		PartDefinition tail2 = tail.addOrReplaceChild(
				"tail2", CubeListBuilder.create().texOffs(81, 20).addBox(-4.0F, -1.0F, 0.0F, 9.0F, 5.0F, 13.0F, new CubeDeformation(0.0F))
						.texOffs(48, 95).addBox(-2.0F, -3.0F, 0.0F, 5.0F, 2.0F, 13.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.0F, 2.0F, 18.0F));
		PartDefinition cube_r11 = tail2.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(0, 29).addBox(-0.5F, -9.0F, 11.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3065F, -0.0832F, 0.0263F));
		PartDefinition cube_r12 = tail2.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(31, 33).addBox(-1.0F, -7.0F, 1.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3054F, 0.0F, 0.0F));
		PartDefinition cube_r13 = tail2.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(25, 59).addBox(-2.0F, -2.5F, 1.75F, 4.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = tail2.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(98, 85).addBox(-2.0F, -3.0F, -1.25F, 4.0F, 2.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(78, 52)
		...
		PartDefinition leftarm = partdefinition.addOrReplaceChild("leftarm",
				CubeListBuilder.create().texOffs(33, 0).addBox(-1.0F, -2.0F, -1.0F, 4.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(42, 12)
						...
						.addBox(0.5F, 14.0F, -11.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(41, 59).addBox(0.5F, 14.0F, -7.0F, 2.0F,
		...
		PartDefinition cube_r15 = leftarm.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(0, 55).addBox(-2.5F, 1.0F, -3.0F, 2.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, 13.0F, -12.0F, -0.1745F, 0.0F, 0.0F));
		PartDefinition rightarm = partdefinition.addOrReplaceChild("rightarm",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -2.0F, -1.0F, 4.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(9, 12)
						...
						.addBox(-2.5F, 14.0F, -11.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(25, 59).addBox(-2.5F, 14.0F, -7.0F, 2.0F,
								6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, -5.723F, -1.4406F, 0.0F, 0.0F, 0.2618F));
		PartDefinition cube_r16 = rightarm.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(50, 33).addBox(0.5F, 1.0F, -3.0F, 2.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 13.0F, -12.0F, -0.1745F, 0.0F, 0.0F));
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 29).addBox(-4.0F, -34.0F, -7.0F, 9.0F, 13.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(73, 73)
		...
		PartDefinition cube_r17 = bb_main.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(60, 73).addBox(-2.0F, -0.5F, -3.5F, 3.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = bb_main.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(81, 38).addBox(-2.25F, -1.5F, -3.5F, 3.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)),
