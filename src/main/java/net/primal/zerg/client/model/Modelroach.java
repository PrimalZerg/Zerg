...
public class Modelroach<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftleg3 = partdefinition.addOrReplaceChild("leftleg3", CubeListBuilder.create(), PartPose.offset(4.0F, 16.0F, 9.0F));
		PartDefinition cube_r17 = leftleg3.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(71, 72).addBox(7.1859F, 4.8955F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = leftleg3.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(45, 64).addBox(5.684F, -4.6559F, -1.5F, 2.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = leftleg3.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(70, 61).addBox(-0.2558F, -1.1558F, -1.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.2558F, 0.1558F, 0.0F, 0.0F, -0.4363F, 0.0F));
		PartDefinition leftleg1 = partdefinition.addOrReplaceChild("leftleg1", CubeListBuilder.create(), PartPose.offset(4.0F, 16.0F, -3.25F));
		PartDefinition cube_r20 = leftleg1.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(55, 64).addBox(6.1897F, 4.8083F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r21 = leftleg1.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(35, 64).addBox(4.6992F, -4.8296F, -1.5F, 2.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r22 = leftleg1.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(64, 35).addBox(-1.2558F, -1.1558F, -1.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.2558F, 0.1558F, 0.0F, 0.0F, 0.48F, 0.0F));
		PartDefinition rightleg3 = partdefinition.addOrReplaceChild("rightleg3", CubeListBuilder.create(), PartPose.offset(-4.0F, 16.0F, 9.0F));
		PartDefinition cube_r23 = rightleg3.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(26, 63).addBox(-10.1821F, 4.9826F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r24 = rightleg3.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(39, 0).addBox(-8.6688F, -4.4823F, -1.5F, 2.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r25 = rightleg3.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(49, 0).addBox(-7.7442F, -1.1558F, -1.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = rightleg2.addOrReplaceChild("cube_r26",
				...
				PartPose.offsetAndRotation(-9.0115F, 6.3116F, 0.0F, 0.0F, 0.0F, 0.0873F));
		PartDefinition cube_r27 = rightleg2.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(0, 23).addBox(-2.0F, -5.5F, -1.5F, 2.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1745F));
		PartDefinition rightleg1 = partdefinition.addOrReplaceChild("rightleg1", CubeListBuilder.create(), PartPose.offset(-4.0F, 16.0F, -3.25F));
		PartDefinition cube_r28 = rightleg1.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(0, 63).addBox(-9.1859F, 4.8955F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r29 = rightleg1.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(0, 0).addBox(-7.684F, -4.6559F, -1.5F, 2.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r30 = rightleg1.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(31, 25).addBox(-6.7442F, -1.1558F, -1.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.2558F, 0.1558F, 0.0F, 0.0F, -0.3927F, 0.0F));
		PartDefinition leftarm = partdefinition.addOrReplaceChild("leftarm", CubeListBuilder.create(), PartPose.offset(6.0F, 11.0F, -1.25F));
		PartDefinition cube_r31 = leftarm.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(37, 6).addBox(-0.5F, -12.7375F, -8.3576F, 1.0F, 2.0F, 17.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r32 = leftarm.addOrReplaceChild("cube_r32",
				CubeListBuilder.create().texOffs(34, 48).addBox(-0.5F, -11.9161F, -6.102F, 1.0F, 2.0F, 14.0F, new CubeDeformation(0.0F))
						.texOffs(55, 25).addBox(-0.5F, -9.9161F, 0.898F, 1.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, -1.0839F, -1.898F, 0.0F, 0.0F, 0.3927F));
		PartDefinition rightarm = partdefinition.addOrReplaceChild("rightarm", CubeListBuilder.create(), PartPose.offset(-6.0F, 11.0F, -1.25F));
		PartDefinition cube_r33 = rightarm.addOrReplaceChild("cube_r33",
				CubeListBuilder.create().texOffs(29, 29).addBox(-0.5F, -13.0848F, -10.3272F, 1.0F, 2.0F, 17.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r34 = rightarm.addOrReplaceChild("cube_r34",
				CubeListBuilder.create().texOffs(48, 25).addBox(-0.5F, -11.9161F, -8.102F, 1.0F, 2.0F, 14.0F, new CubeDeformation(0.0F))
						.texOffs(49, 25).addBox(-0.5F, -9.9161F, -1.102F, 1.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
