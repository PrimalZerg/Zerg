...
public class HostileZerglingEntity extends Monster {
	...
	public HostileZerglingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ZergModEntities.HOSTILE_ZERGLING.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ZergModEntities.HOSTILE_ZERGLING.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
