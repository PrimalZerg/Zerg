...
public class LarvaEntity extends PathfinderMob {
	public LarvaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ZergModEntities.LARVA.get(), world);
	}

	public LarvaEntity(EntityType<LarvaEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return new TextComponent("Larva");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(LarvaEntity.this.getId());
					return new CooconstorageMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
