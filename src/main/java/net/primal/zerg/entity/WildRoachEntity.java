...
public class WildRoachEntity extends TamableAnimal {
	...
	public WildRoachEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ZergModEntities.WILD_ROACH.get(), world);
	}

	public WildRoachEntity(EntityType<WildRoachEntity> type, Level world) {
		super(type, world);
		xpReward = 3;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(ZergModEntities.WILD_ROACH.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
