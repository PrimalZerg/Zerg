...
public class DeepslatemineraloreFeature extends OreFeature {
	public static DeepslatemineraloreFeature FEATURE = null;
	...
	public DeepslatemineraloreFeature() {
	...
	private static class DeepslatemineraloreFeatureRuleTest extends RuleTest {
		static final DeepslatemineraloreFeatureRuleTest INSTANCE = new DeepslatemineraloreFeatureRuleTest();
		private static final com.mojang.serialization.Codec<DeepslatemineraloreFeatureRuleTest> CODEC = com.mojang.serialization.Codec
				.unit(() -> INSTANCE);
		private static final RuleTestType<DeepslatemineraloreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;
